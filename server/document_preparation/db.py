...
DEFAULT_DATABASE_URL = (
    f"sqlite:///{PROJECT_ROOT / 'data' / 'crossbridge_document_preparation.db'}"
)
ALEMBIC_INI = SERVICE_ROOT / "alembic.ini"

# Env override key is distinct from Function 1's so the two services never share a DB.
ENV_DATABASE_URL = "CROSSBRIDGE_DOCUMENTS_DATABASE_URL"
